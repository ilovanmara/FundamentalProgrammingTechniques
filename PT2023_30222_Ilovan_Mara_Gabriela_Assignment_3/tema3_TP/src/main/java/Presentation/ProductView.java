...
public class ProductView extends JFrame{
    ...
    private JButton addBtn = new JButton("Add new product");
    private JButton editBtn = new JButton("Edit product");
    private JButton deleteBtn = new JButton("Delete product");
    private JButton viewBtn = new JButton("View all products");
    ...
    public void insertPanelAdd(){
        ...
        priceLbl.setBounds(120, 340, 200, 25);
        priceLbl.setFont(new Font("Century",Font.CENTER_BASELINE,16));
        totalLbl.setBounds(120, 370, 200, 25);
        totalLbl.setFont(new Font("Century",Font.CENTER_BASELINE,16));

        nameTxt.setBounds(220, 310, 300, 25);
        priceTxt.setBounds(220, 340, 300, 25);
        totalTxt.setBounds(220, 370, 300, 25);
    }
